        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/home" class="site_title"><i class="fa tasks"></i> <span>PerPus-Ku</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Transaksi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/peminjaman">Tabel Peminjaman</a></li>
                      <li><a href="/penerimaan">Tabel Penerimaan</a></li>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Perpus-KU <br/> Creative, inovatif, interesting</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <th scope="col">No tlp penerbit</th>
                    ...
                    <td>
                    <a href="/Penerbit/edit/{{$pn->Id_penerbit}}" class="btn btn-success">EDIT</a>
                    <a href="/Penerbit/hapus/{{$pn->Id_penerbit}}" class="btn btn-danger">HAPUS</a>
                        </td>
                        </tr>
                        @endforeach
                      </tbody>
